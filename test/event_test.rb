...
class EventTest < Minitest::Test
  ...
  def test_finding_food_trucks_that_sell
    event = Event.new("South Pearl Street Farmers Market")
    food_truck1 = FoodTruck.new("Rocky Mountain Pies")
  ...
  def test_it_can_find_food_truck_potential_revenues
    event = Event.new("South Pearl Street Farmers Market")
    food_truck1 = FoodTruck.new("Rocky Mountain Pies")
    item1 = Item.new({name: 'Peach Pie (Slice)', price: "$3.75"})
    item2 = Item.new({name: 'Apple Pie (Slice)', price: '$2.50'})
  ...
  def test_it_can_get_item_list
    ...
    assert_equal [item1, item2, item4, item3], event.item_list
  end

  def test_it_can_find_item_details
    event = Event.new("South Pearl Street Farmers Market")
    item1 = Item.new({name: 'Peach Pie (Slice)', price: "$3.75"})
    item2 = Item.new({name: 'Apple Pie (Slice)', price: '$2.50'})
    item3 = Item.new({name: "Peach-Raspberry Nice Cream", price: "$5.30"})
    ...
    assert_equal expected_total_inventory, event.total_inventory
  end
end
